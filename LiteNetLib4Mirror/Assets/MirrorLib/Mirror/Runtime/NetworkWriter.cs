...
namespace Mirror
{
    internal readonly struct BufferHolder
    {
        internal readonly bool writer;
        internal readonly object data;

        public BufferHolder(NetworkWriter data)
        {
            writer = true;
            this.data = data;
        }
