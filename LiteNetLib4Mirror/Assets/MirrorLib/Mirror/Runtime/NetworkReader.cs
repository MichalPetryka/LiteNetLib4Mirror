...
namespace Mirror
{
    ...
    public class NetworkReader
    {
        ...
        {
            UIntFloat converter = new UIntFloat {intValue = ReadUInt32()};
            return converter.floatValue;
        }
        public double ReadDouble()
        {
            UIntDouble converter = new UIntDouble {longValue = ReadUInt64()};
            return converter.doubleValue;
        }
        public decimal ReadDecimal()
        {
            UIntDecimal converter = new UIntDecimal {longValue1 = ReadUInt64(), longValue2 = ReadUInt64()};
